...
import ifpe.surpriseme.activities.BackgroundActivity;
...
public class FlickrManager {
    ...
    private static final String APIKEY_SEARCH_STRING = "&api_key=a9ea4b229109908309f6fbd86c4f8fec";
    ...
    public static class GetThumbnailsThread extends Thread {
        BackgroundActivity.UIHandler uih;
